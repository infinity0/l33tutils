...
#   - you must manually put your .gnupg with your master secret key here, before using this tool
...
agcaff_sign() {
	...
	test -d "$shome" || abort "set shome to a directory on your secure partition (where .gnupg is)."
